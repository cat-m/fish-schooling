...
# has problems with gridlock:
    # the need for collision avoidance strategies
    # is becoming more and more apparent,
    # but that's a different project

# mean of neighbors influences own direction
# by taking mean of neighbors INCLUDING SELF
# then mean becomes new direction
...
# this version does have the 'herky jerky' movement
