...
# heavy gridlock
# mean test solution from before version 1.1
# somewhat biased North and East, I think
# DOES separate somewhat into homogenous clusters

# counts self along with neighbors when taking mean
...
# this version definitely has 'herky jerky' movement
